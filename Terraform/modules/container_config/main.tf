  ...
  container_definitions = {
    api_gateway = {
      ...
      env_vars = {
        ...
        ROUTE_1_DOWNSTREAM_HOST  = "microservice-1-cloudmap.microservice-1.local"
        ...
        ROUTE_2_DOWNSTREAM_HOST  = "microservice-2-cloudmap.microservice-2.local"
        ROUTE_2_DOWNSTREAM_PORT  = "5001"
        ROUTE_2_DOWNSTREAM_PATH  = "/api/auth/{everything}"
        # Resource and Post services not deployed in current ECS setup
        # ROUTE_3_UPSTREAM_PATH    = "/api/resource/{everything}"
        # ROUTE_3_UPSTREAM_METHODS = "Get,Post,Put,Delete"
        # ROUTE_3_DOWNSTREAM_HOST  = "resource-service.local"
        ...
        # ROUTE_4_DOWNSTREAM_HOST  = "post-service.local"
